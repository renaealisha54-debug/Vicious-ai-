...
PROJECTS = {
    "ai": os.path.expanduser("~/ollama/vicious-projects/vicious-ai"),
...
# Taught commands written by the Vicious AI app's "+ TEACH" / "SYNC"
...
while True:
    ...
    if matched_trigger:
        ...
        subprocess.run(["termux-open-url", "https://github.com/renaealisha54-debug/Vicious-ai-"])
        ...
        print("💡 You can say things like 'open github', 'cd ai', 'teach <trigger> to <command>', 'where am i', or 'hello'")
